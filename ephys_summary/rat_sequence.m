...
rats = [cell_list{2:end,3}];
%THISRAT = 'H037';
H037 = ismember(rats, 'H037');
H066 = ismember(rats, 'H066');
H084 = ismember(rats, 'H084');
H129 = ismember(rats, 'H129');
...
select_str = ['strcmp(region,''fof'') & normmean > .5 & strcmp(ratname,''' THISRAT ''')'];
...
print(fh1,['~/Dropbox/spikes/figures/PSTH/sequence_plot_' THISRAT ] , '-dsvg')
...
%save(['~/Dropbox/spikes/bin/ephys_summary/sorted_cells_' THISRAT '.mat'],'sorted_cellids','sorted_stim_cells','sorted_post_stim_cells')
