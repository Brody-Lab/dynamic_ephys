function [] = fr_rat_summary(THISRAT)
...
fig.PaperSize = [6 6];
print(['~/Dropbox/spikes/figures/PSTH/' THISRAT '_avg_fr'],'-dsvg')
...
fig.PaperPositionMode = 'Manual';
fig.PaperSize = [6 6];
print(['~/Dropbox/spikes/figures/PSTH/' THISRAT '_avg_fr_diff'],'-dsvg')
...
fig.PaperPositionMode = 'Manual';
fig.PaperSize = [6 6];
print(['~/Dropbox/spikes/figures/PSTH/' THISRAT '_avg_psth_cin'],'-dsvg')
...
fig.PaperPositionMode = 'Manual';
fig.PaperSize = [6 6];
print(['~/Dropbox/spikes/figures/PSTH/' THISRAT '_avg_psth_cout'],'-dsvg')
