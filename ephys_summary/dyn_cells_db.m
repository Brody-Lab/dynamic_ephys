...
if ~force && exist(save_path, 'file')
    ...
    cell_list = {'cellnum' 'region' 'ratname' 'cellid' 'sessid' ...
        'sessiondate' 'lr' 'hitfrac'...
        'mingamma' 'brainsideright' ...
        'prefsideright' 'prefp' ...
        'normmean' 'prefsideright_mv' 'prefp_mv' 'min_p' 'prefsideright_cout100' 'prefp_cout100' ...
    ...
    for i=1:numel(multi)
        ...
        cell_list = [cell_list ; ...
            {i data.region data.ratname data.cellid data.sessid ...
            data.sessiondate data.lapse_rate mean(data.trials.hit)...
            data.min_gamma data.brainsideright ...
            data.prefsideright{stim_index} data.prefp{stim_index} ...
            data.norm_mean ...
