...
if isempty(transparent); transparent = 0; end

if nargin<6, saturation= 0.55; end;
...
edgeColor=col+(1-col)*saturation;
patchSaturation=saturation;%0.15; %How de-saturated or transparent to make patch
if transparent
