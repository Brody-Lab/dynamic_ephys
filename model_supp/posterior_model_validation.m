...
source_data.S9.posterior.model_mean = posteriorF.maF;
source_data.S9.posterior.sample_mean = pfma;
source_data.S9.posterior.time = forward.T;
...
source_data.S9.posterior.model_var = posteriorF.vaF;
source_data.S9.posterior.sample_var = pfva;
...
source_data.S9.posterior.sample_slice100ms = posteriorF.pdf(1000,:);
source_data.S9.posterior.model_slice100ms = posteriorP.pdf(1000,:);

source_data.S9.posterior.sample_slice300ms = posteriorF.pdf(3000,:);
source_data.S9.posterior.model_slice300ms = posteriorP.pdf(3000,:);

source_data.S9.posterior.sample_slice500ms = posteriorF.pdf(5000,:);
source_data.S9.posterior.model_slice500ms = posteriorP.pdf(5000,:);

source_data.S9.posterior.sample_slice700ms = posteriorF.pdf(7000,:);
source_data.S9.posterior.model_slice700ms = posteriorP.pdf(7000,:);

source_data.S9.posterior.sample_slice900ms = posteriorF.pdf(9000,:);
source_data.S9.posterior.model_slice900ms = posteriorP.pdf(9000,:);

source_data.S9.posterior.sample_slice_end_minus1 = posteriorF.pdf(end-1,:);
source_data.S9.posterior.model_slice_end_minus1 = posteriorP.pdf(end-1,:);

source_data.S9.posterior.sample_slice_end = posteriorF.pdf(end,:);
source_data.S9.posterior.model_slice_end = posteriorP.pdf(end,:);
...
%%
save(fullfile(dp.data_dir,'figS9_source_data'), 'source_data')
